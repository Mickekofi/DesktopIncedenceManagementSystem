...
Partial Class UC_IncidentFeeds
    ...
    Private Sub InitializeComponent()
        ...
        Panel6 = New Panel()
        Label12 = New Label()
        cmbFilterNewOrOld = New ComboBox()
        Label10 = New Label()
        cmbFilterCategory = New ComboBox()
        lblFullName = New Label()
        Label9 = New Label()
        Label8 = New Label()
        cmbFilterCampus = New ComboBox()
        btnAssignSecurity = New Button()
        Label7 = New Label()
        cmbAssignSecurity = New ComboBox()
        Label6 = New Label()
        ...
        txtIncidentLocation.Font = New Font("Garamond", 18.0F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        ...
        txtDescription.Font = New Font("Garamond", 18.0F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        ...
        btnExport.Location = New Point(1443, 15)
        ...
        Panel1.Name = "Panel1"
        Panel1.Size = New Size(2256, 1002)
        Panel1.TabIndex = 2
        ' 
        ' Panel6
        ' 
        ...
        Panel6.Controls.Add(cmbFilterNewOrOld)
        Panel6.Controls.Add(Label10)
        Panel6.Controls.Add(cmbFilterCategory)
        Panel6.Controls.Add(lblFullName)
        Panel6.Controls.Add(Label9)
        Panel6.Controls.Add(Label8)
        Panel6.Controls.Add(cmbFilterCampus)
        Panel6.Controls.Add(btnAssignSecurity)
        Panel6.Controls.Add(Label7)
        Panel6.Controls.Add(cmbAssignSecurity)
        ...
        Label12.TabIndex = 45
        Label12.Text = "Filter by type"
        ' 
        ' cmbFilterNewOrOld
        ' 
        cmbFilterNewOrOld.BackColor = SystemColors.Info
        cmbFilterNewOrOld.Font = New Font("Garamond", 15.75F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        cmbFilterNewOrOld.ForeColor = Color.Red
        cmbFilterNewOrOld.FormattingEnabled = True
        cmbFilterNewOrOld.Items.AddRange(New Object() {"South Campus", "North Campus", "Central Campus", "Ajumako Campus"})
        cmbFilterNewOrOld.Location = New Point(239, 50)
        cmbFilterNewOrOld.Margin = New Padding(4, 5, 4, 5)
        cmbFilterNewOrOld.Name = "cmbFilterNewOrOld"
        cmbFilterNewOrOld.Size = New Size(413, 44)
        cmbFilterNewOrOld.TabIndex = 44
        cmbFilterNewOrOld.Text = "--Select--"
        ' 
        ' Label10
        ' 
        ...
        Label10.Size = New Size(201, 33)
        Label10.TabIndex = 43
        Label10.Text = "Filter Category"
        ' 
        ' cmbFilterCategory
        ' 
        cmbFilterCategory.BackColor = SystemColors.Info
        cmbFilterCategory.Font = New Font("Garamond", 15.75F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        cmbFilterCategory.ForeColor = Color.Red
        cmbFilterCategory.FormattingEnabled = True
        cmbFilterCategory.Items.AddRange(New Object() {"South Campus", "North Campus", "Central Campus", "Ajumako Campus"})
        cmbFilterCategory.Location = New Point(239, 131)
        cmbFilterCategory.Margin = New Padding(4, 5, 4, 5)
        cmbFilterCategory.Name = "cmbFilterCategory"
        cmbFilterCategory.Size = New Size(413, 44)
        cmbFilterCategory.TabIndex = 42
        cmbFilterCategory.Text = "--Select--"
        ' 
        ' lblFullName
        ' 
        ...
        lblFullName.Location = New Point(230, 363)
        ...
        Label8.TabIndex = 38
        Label8.Text = "Filter Campus"
        ' 
        ' cmbFilterCampus
        ' 
        cmbFilterCampus.BackColor = SystemColors.Info
        cmbFilterCampus.Font = New Font("Garamond", 15.75F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        cmbFilterCampus.ForeColor = Color.Red
        cmbFilterCampus.FormattingEnabled = True
        cmbFilterCampus.Items.AddRange(New Object() {"South Campus", "North Campus", "Central Campus", "Ajumako Campus"})
        cmbFilterCampus.Location = New Point(234, 203)
        cmbFilterCampus.Margin = New Padding(4, 5, 4, 5)
        cmbFilterCampus.Name = "cmbFilterCampus"
        cmbFilterCampus.Size = New Size(413, 44)
        cmbFilterCampus.TabIndex = 37
        cmbFilterCampus.Text = "--Select--"
        ' 
        ' btnAssignSecurity
        ' 
        btnAssignSecurity.BackColor = Color.FromArgb(CByte(192), CByte(0), CByte(0))
        btnAssignSecurity.Font = New Font("Segoe UI", 10.0F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        btnAssignSecurity.ForeColor = Color.White
        btnAssignSecurity.Location = New Point(239, 637)
        btnAssignSecurity.Margin = New Padding(4, 5, 4, 5)
        btnAssignSecurity.Name = "btnAssignSecurity"
        btnAssignSecurity.Size = New Size(282, 61)
        btnAssignSecurity.TabIndex = 36
        btnAssignSecurity.Text = "Assign Security"
        btnAssignSecurity.UseVisualStyleBackColor = False
        ' 
        ' Label7
        ' 
        ...
        Label7.Location = New Point(8, 564)
        Label7.Margin = New Padding(4, 0, 4, 0)
        Label7.Name = "Label7"
        Label7.Size = New Size(205, 33)
        Label7.TabIndex = 30
        Label7.Text = "Assign Security"
        ' 
        ' cmbAssignSecurity
        ' 
        cmbAssignSecurity.BackColor = SystemColors.Info
        cmbAssignSecurity.Font = New Font("Garamond", 15.75F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        cmbAssignSecurity.ForeColor = Color.Red
        cmbAssignSecurity.FormattingEnabled = True
        cmbAssignSecurity.Items.AddRange(New Object() {"South Patrol Team", "North Patrol Team", "Central Patrol Team", "Ajumako Patrol Team"})
        cmbAssignSecurity.Location = New Point(236, 556)
        cmbAssignSecurity.Margin = New Padding(4, 5, 4, 5)
        cmbAssignSecurity.Name = "cmbAssignSecurity"
        cmbAssignSecurity.Size = New Size(353, 44)
        cmbAssignSecurity.TabIndex = 29
        cmbAssignSecurity.Text = "--Select--"
        ' 
        ' Label6
        ' 
        ...
        cmbUserName.Location = New Point(234, 275)
        ...
        Name = "UC_IncidentFeeds"
        Size = New Size(2256, 1002)
    ...
    Friend WithEvents cmbAssignSecurity As ComboBox
    Friend WithEvents Label7 As Label
    Friend WithEvents btnAssignSecurity As Button
    Friend WithEvents Label8 As Label
    Friend WithEvents cmbFilterCampus As ComboBox
    Friend WithEvents lblFullName As Label
    Friend WithEvents Label9 As Label
    Friend WithEvents Label10 As Label
    Friend WithEvents cmbFilterCategory As ComboBox
    Friend WithEvents Label12 As Label
    Friend WithEvents cmbFilterNewOrOld As ComboBox
